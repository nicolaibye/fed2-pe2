...
function VenueSquareListing() {
  ...
  return (
    <li className={`w-full shrink-0 h-auto aspect-square flex flex-col`}>
      <div className="flex-1 object-cover relative">
        ...
        {adventureType === "affluent" ? (
          ...
          <>
            ...
            >
              <li className="square-venue-label w-fit">Free cancellation</li>
            ...
            >
              ...
              <li className="square-venue-label w-fit">Breakfast included</li>
            </ul>
          </>
        )}
      </div>
